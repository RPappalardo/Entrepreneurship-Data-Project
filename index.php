	...
	<!--START Navigation Menu -->
		...
		<div class="row">-->
			...
			<!--				<img style="width:35%;" src="http://homegrowntools.unc.edu/wp-content/themes/casestudy/img/logonewWhite.png" id="logoHomePage"> -->
               <div  id="logoHomePage"><h1 class= "fontstuff" style = "font-size: 2.5em !important;color: white">ENTREPRENEURSHIP<br/><span style="font-weight:400; color: white">Data Project</span></h1></div>
					</div>
			</div>
